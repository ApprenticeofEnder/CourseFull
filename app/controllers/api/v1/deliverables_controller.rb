...
module Api
  module V1
    class DeliverablesController < Api::V1::ApplicationController
      ...
      before_action :set_api_v1_course, only: %i[create]
      ...
      def create
        ...
        return render json: @api_v1_deliverable.errors, status: :unprocessable_entity unless @api_v1_deliverable.save
      ...
      def update
        unless @api_v1_deliverable.update(api_v1_deliverable_update_params)
          return render json: @api_v1_deliverable.errors, status: :unprocessable_entity
        end
      ...
      def destroy
        ...
        @course.update_goals
        @course.save
        Rails.logger.info("Deleted deliverable #{@api_v1_deliverable.id}.")
      end
